import { Ref, ref, watch, onBeforeUnmount, computed, isRef, getCurrentInstance, nextTick } from 'vue';
...
interface UseQueryReturn<TResult, TVariables> {
    result: Ref<TResult>
    loading: Ref<boolean>
 ...
 * */
export function useLazyQuery<TResult = any>(
 ...
 */
export function useLazyQuery<TResult = any, TVariables extends OperationVariables = OperationVariables>(
    document: DocumentNode | Ref<DocumentNode> | ReactiveFunction<DocumentNode>
 ...
 */
export function useLazyQuery<TResult = any, TVariables extends undefined = undefined>(
    document: DocumentNode | Ref<DocumentNode> | ReactiveFunction<DocumentNode>,
    variables: TVariables,
